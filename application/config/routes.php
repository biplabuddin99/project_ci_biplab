...
*/
$route['default_controller'] = 'DefaultCtrl';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
$route['user'] = 'AuthCtrl/auth_retrive';
...
$route['admission'] = 'AuthCtrl/index';
$route['admission/add'] = 'AuthCtrl/admission_create';
$route['admission/edit/(:num)'] = 'AuthCtrl/update/$1';
$route['admission/delete/(:num)'] = 'AuthCtrl/destroy/$1';
...
// font student form
$route['stulist'] = 'FormCtrl/index';
$route['newstudent'] = 'FormCtrl/admission_create';
